...
public class Thanos {
    ...
    public static void main(String[] args) {
        ...
        Comparator<Hero> comparator = new Comparator<Hero>() {
            public int compare(Hero firstLetterName, Hero compare) {
                return firstLetterName.getName().compareTo(compare.getName());
            }
        };
        ...
        boolean isBegoniaHere = party.containsValue(begonia);
        System.out.println(isBegoniaHere);
